			...
			columns: [
				...
				},
				{
					...
					template: function(data) {
						return '\
                            <div class="d-flex">\
                                <a href="/client/intakes/'+data.id+'/view" class="btn btn-outline-primary btn btn-sm btn-default btn-icon mr-2" title="View details">\
                                    <i class="flaticon2-document"></i>\
                                </a>\
								<a href="/client/intakes/'+data.id+'/edit" class="btn btn-outline-secondary btn btn-sm btn-default btn-icon mr-2" title="Edit details">\
