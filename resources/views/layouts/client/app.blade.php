                ...
                <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                    ...
                    <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                        ...
                        <ul class="menu-nav">
                            ...
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/intakes')) == 'integer' ? 'menu-item-open' : null }}"
                                ...
                                <div class="menu-submenu">
                                    ...
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/client/intakes/create')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                        ...
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/client/intakes')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                            ...
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/appointments')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <span class="svg-icon svg-icon-muted svg-icon-2hx">
                            ...
                            {{-- <li class="menu-item menu-item {{ gettype(strpos(url()->full(), '/client/scholarships/')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item menu-i {{ gettype(strpos(url()->full(), '/client/scholarships')) == 'integer' ? 'menu-item-active' : null }}"
                                aria-haspopup="true">
                                <a href="/client/scholarships" class="menu-link">
                                    <span class="svg-icon menu-icon">
                                        <svg width="22" height="23" viewBox="0 0 22 23" fill="none"
                            ...
                            <li class="menu-item menu-i {{ gettype(strpos(url()->full(), '/client/applicants')) == 'integer' ? 'menu-item-active' : null }}"
                                aria-haspopup="true">
                            ...
                            <li class="menu-item menu-item-submenu {{ gettype(strpos(url()->full(), '/resources')) == 'integer' ? 'menu-item-open' : null }}"
                                aria-haspopup="true" data-menu-toggle="hover">
                                <a href="javascript:;" class="menu-link menu-toggle">
                                    <span class="svg-icon menu-icon">
                                        <span class="svg-icon svg-icon-muted svg-icon-2hx">
                                ...
                                <div class="menu-submenu">
                                    <i class="menu-arrow"></i>
                                    <ul class="menu-subnav">
                                        <li class="menu-item {{ gettype(strpos(url()->full(), '/client/resources')) == 'integer' ? 'menu-item-active' : null }}"
                                            aria-haspopup="true">
                                            <a href="/client/resources" class="menu-link">
                                                <i class="menu-bullet menu-bullet-dot">
                                                    <span></span>
                                                </i>
                                                    ...
                                                    <ul class="menu-subnav">
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="/client/intakes/create" class="menu-link">
                                                                ...
                                                                <span class="menu-text">Add New Intakes</span>
                                                            </a>
                                                        </li>
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="/client/intakes" class="menu-link">
                                                    ...
                                                    <ul class="menu-subnav">
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="#" class="menu-link">
                                                                ...
                                                                <span class="menu-text">Add New Documents</span>
                                                            </a>
                                                        </li>
                                                        <li class="menu-item" aria-haspopup="true">
                                                            <a href="#" class="menu-link">
                        ...
                        <div class="topbar-item">
                            <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                                ...
                                <span class="symbol symbol-lg-35 symbol-25 symbol-light-success mr-3    ">
                                    <span
                                        class="symbol-label font-size-h5 font-weight-bold">{{ mb_substr(Auth::guard('web')->user()->name, 0, 1) }}</span>
                                </span>
                                <span
                                    class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Hi,</span>
                                <span
                                    class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-1">{{ strtok(Auth::guard('web')->user()->name, ' ') }}</span>
                            </div>
                        </div>
                        <!--end::User-->
                    </div>
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="navi navi-spacer-x-0 p-0">
                ...
                <a href="/client/change-password" class="navi-item">
                    <div class="navi-link">
                        <div class="symbol symbol-40 bg-light mr-3">
                            <div class="symbol-label">
                                <span class="svg-icon svg-icon-primary svg-icon-2x">
            ...
            <div id="kt_quick_cart" class="offcanvas offcanvas-right p-10">
                ...
                <div class="offcanvas-content">
                    ...
                    <div class="offcanvas-wrapper mb-5 scroll-pull">
                        ...
                        <div class="d-flex align-items-center justify-content-between py-8">
                            <div class="d-flex flex-column mr-2">
                                <a href="#" class="font-weight-bold text-dark text-hover-primary">4D
                                    Printer</a>
                        ...
                        <div class="d-flex align-items-center justify-content-between py-8">
                            <div class="d-flex flex-column mr-2">
                                <a href="#"
                                    class="font-weight-bold text-dark text-hover-primary">MotionWire</a>
                            ...
                            <div class="navi navi-icon-circle navi-spacer-x-0">
                                ...
                                <a href="#" class="navi-item">
                                    <div class="navi-link rounded">
                                        ...
                                        <div class="navi-text">
                                            <div class="font-weight-bold font-size-lg">5 new user generated report
                                            </div>
                                ...
                                <a href="#" class="navi-item">
                                    <div class="navi-link rounded">
                                        ...
                                        <div class="navi-text">
                                            <div class="font-weight-bold font-size-lg">$2900 worth producucts sold
                                            </div>
                                ...
                                <a href="#" class="navi-item">
                                    <div class="navi-link rounded">
                                        ...
                                        <div class="navi-text">
                                            <div class="font-weight-bold font-size-lg">4.5h-avarage response time
                                            </div>
                                ...
                                <a href="#" class="navi-item">
                                    <div class="navi-link rounded">
                                        ...
                                        <div class="navi-text">
                                            <div class="font-weight-bold font-size-lg">Avarage 4 blog posts per
                                                author</div>
                                ...
                                <a href="#" class="navi-item">
                                    <div class="navi-link rounded">
                                        ...
                                        <div class="navi-text">
                                            <div class="font-weight-bold font-size-lg">16 authors joined last week
                                            </div>
                                ...
                                <a href="#" class="navi-item">
                                    <div class="navi-link rounded">
                                        ...
                                        <div class="navi-text">
                                            <div class="font-weight-bold font-size-lg">2.8 GB-total downloads size
                                            </div>
                                ...
                                <a href="#" class="navi-item">
                                    <div class="navi-link rounded">
                                        ...
                                        <div class="navi-text">
                                            <div class="font-weight-bold font-size-lg">7 new user generated report
                                            </div>
                                            <div class="text-muted">Reports based on sales</div>
                                        </div>
                                    </div>
                ...
                <div class="offcanvas-content">
                    ...
                    <div class="offcanvas-wrapper mb-5 scroll-pull">
                        ...
                        <div class="overlay rounded-lg mb-8 offcanvas-demo">
                            ...
                            <div class="overlay-layer">
                                <a href="https://preview.keenthemes.com/metronic/demo2/index.html"
                                    class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
                                    target="_blank">Default</a>
                        ...
                        <div class="overlay rounded-lg mb-8 offcanvas-demo">
                            ...
                            <div class="overlay-layer">
                                <a href="https://preview.keenthemes.com/metronic/demo3/index.html"
                                    class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
                                    target="_blank">Default</a>
                        ...
                        <div class="overlay rounded-lg mb-8 offcanvas-demo">
                            ...
                            <div class="overlay-layer">
                                <a href="https://preview.keenthemes.com/metronic/demo4/index.html"
                                    class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
                                    target="_blank">Default</a>
                        ...
                        <div class="overlay rounded-lg mb-8 offcanvas-demo">
                            ...
                            <div class="overlay-layer">
                                <a href="https://preview.keenthemes.com/metronic/demo6/index.html"
                                    class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
                                    target="_blank">Default</a>
                        ...
                        <div class="overlay rounded-lg mb-8 offcanvas-demo">
                            ...
                            <div class="overlay-layer">
                                <a href="https://preview.keenthemes.com/metronic/demo7/index.html"
                                    class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
                                    target="_blank">Default</a>
                        ...
                        <div class="overlay rounded-lg mb-8 offcanvas-demo">
                            ...
                            <div class="overlay-layer">
                                <a href="https://preview.keenthemes.com/metronic/demo8/index.html"
                                    class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
                                    target="_blank">Default</a>
                        ...
                        <div class="overlay rounded-lg mb-8 offcanvas-demo">
                            ...
                            <div class="overlay-layer">
                                <a href="https://preview.keenthemes.com/metronic/demo9/index.html"
                                    class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
                                    target="_blank">Default</a>
                        ...
                        <div class="overlay rounded-lg mb-8 offcanvas-demo">
                            ...
                            <div class="overlay-layer">
                                <a href="https://preview.keenthemes.com/metronic/demo11/index.html"
                                    class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
                                    target="_blank">Default</a>
                        ...
                        <div class="overlay rounded-lg mb-8 offcanvas-demo">
                            ...
                            <div class="overlay-layer">
                                <a href="https://preview.keenthemes.com/metronic/demo12/index.html"
                                    class="btn btn-white btn-text-primary btn-hover-primary font-weight-boldest text-center min-w-75px shadow"
                                    target="_blank">Default</a>
