...
<html lang="en">
	...
	<head>
		...
		<link href="/assets/plugins/custom/fullcalendar/fullcalendar.bundle9cd7.css?v=7.1.5" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
		...
		<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="https://ml5qkd9yohde.i.optimole.com/w:253/h:73/q:mauto/f:avif/https://parentvillage.wetestlink.com/wp-content/uploads/2023/06/Untitled-1-2-1.png" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
							...
							<div class="topbar">
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ strtok(Auth::guard('web')->user()->name, " ") }}</span>
										<span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
											<span class="symbol-label font-size-h5 font-weight-bold">{{ mb_substr(Auth::guard('web')->user()->name, 0, 1); }}</span>
										</span>
									</div>
								</div>
								<!--end::User-->
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="d-flex align-items-center mt-5">
					...
					<div class="d-flex flex-column">
						<a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{ Auth::guard('web')->user()->name }}</a>
						<div class="navi mt-2">
							<a href="#" class="navi-item">
							...
							<a href="/client/logout" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Sign Out</a>
						</div>
					</div>
				</div>
				<!--end::Header-->
