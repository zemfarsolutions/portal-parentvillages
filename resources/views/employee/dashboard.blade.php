                            ...
                            <div class="card-body p-0">
                                <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                                    ...
                                    <div class="d-flex flex-column text-right">
                                        ...
                                        <span class="text-muted font-weight-bold mt-2">Milage Logs</span>
                                    </div>
                                </div>
                                <div id="milage_logs_chart" class="card-rounded-bottom" data-color="success" style="height: 200px"></div>
                            </div>
                            <!--end::Body-->
                        </div> --}}
                        <!--end::Stats Widget 11-->
                        <!--begin::Stats Widget 11-->
                            {{-- <div class="card card-custom card-stretch card-stretch-half gutter-b" style="height: fit-content;">
                                <!--begin::Body-->
                                <div class="card-body p-0">
                                    <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                                        <span class="symbol symbol-50 symbol-light-success mr-2">
                                    ...
                                    <div id="milage_logs_chart" class="card-rounded-bottom" data-color="success" style="height: 150px"></div>
                                </div>
                                <!--end::Body-->
                            </div> --}}
                        <!--end::Stats Widget 11-->
                        ...
                        <div class="card card-custom card-stretch card-stretch-half gutter-b" style="height: 100%">
                            ...
                            <div class="card-body p-0">
                                <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
                                    ...
                                    <div class="d-flex flex-column text-right">
                                        <span class="text-dark-75 font-weight-bolder font-size-h3"></span>
                                        <span class="text-muted font-weight-bold mt-2">Expenses</span>
                                    </div>
                                </div>
                                <div id="expense_chart" class="card-rounded-bottom" data-color="primary" style="height: 300px"></div>
                            </div>
                            <!--end::Body-->
                        </div>
                        <!--end::Stats Widget 12-->
