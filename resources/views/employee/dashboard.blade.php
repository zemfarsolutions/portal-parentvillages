    ...
    <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center">
                <!--begin::Actions-->
                <a href="/employee/evaluations" class="btn btn-light-primary font-weight-bolder btn-sm">Evaluation
                    Process</a>
                <!--end::Actions-->
            </div>
            <!--end::Toolbar-->
            ...
            <div class="row">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <!--begin::Card-->
                            <a href="/employee/expenses" class="card card-custom wave wave-animate-fast bg-grey-100">
                                <!--begin::Card Body-->
                                <div class="card-body">
                                    <div class="d-flex align-items-center p-6">
                                        <!--begin::Icon-->
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <div class="card card-custom card-stretch card-stretch-half gutter-b" style="height: 100%">
                                ...
                                <div class="card-body">
                                    <div id="time_tracking_chart" class="card-rounded-bottom" data-color="primary"
                                        style="height: 350px"></div>
                                </div>
                                <!--end::Body-->
                            </div>
