    ...
    <div class="subheader py-2 py-lg-6 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="/employee/milaege-logs" class="text-muted">Logs</a>
                        </li>
                        <li class="breadcrumb-item">
                            <a href="/employee/milaege-logs/create" class="text-muted">Add Log</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="d-flex align-items-center">
                <!--begin::Actions-->
                <a href="/employee/milaege-logs" class="btn btn-light-primary font-weight-bolder btn-sm">Go Back</a>
                <!--end::Actions-->
            </div>
            <!--end::Toolbar-->
        </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Add Log</h3>
                        </div>
                        <!--begin::Form-->
                        <form class="form" method="POST" action="{{ route('milaege-logs.store') }}">
