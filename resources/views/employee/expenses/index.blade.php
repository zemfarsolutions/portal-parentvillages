                ...
                <div class="d-flex align-items-baseline flex-wrap mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        <li class="breadcrumb-item">
                            <a href="" class="text-muted">View Expenses</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom">
                <div class="card-header py-3">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--end::Dropdown-->
                        <!--begin::Button-->
                        <a href="/employee/expenses/create" class="btn btn-primary font-weight-bolder">
                            <i class="la la-plus"></i>New Expense</a>
                        <!--end::Button-->
                    </div>
                </div>
                <div class="card-body">
...
@section('scripts')
    <script src="/assets/js/pages/expenses/index.js?v=7.1.5"></script>
@endsection
