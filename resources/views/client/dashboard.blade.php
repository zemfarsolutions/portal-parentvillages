        ...
        <div class="container py-8">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <!--begin::Card-->
                        <a href="/client/intakes/create" class="card card-custom wave wave-animate-slow bg-grey-100 mb-8 mb-lg-0">
                            <!--begin::Card Body-->
                            <div class="card-body">
                    ...
                    <div class="col-lg-4">
                        <!--begin::Card-->
                        <a href="/client/appointments/create" class="card card-custom wave wave-animate bg-grey-100 mb-8 mb-lg-0">
                            <!--begin::Card Body-->
                            <div class="card-body">
                                <div class="d-flex align-items-center p-6">
                                    <!--begin::Icon-->
